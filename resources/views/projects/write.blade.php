                    ...
                    <div class="w-100">
                        <div class="f-left w-50">
                            <div class="form-group">
                                ...
                                <div class="custom-input">
                                    <input type="text" id="title" name="title" placeholder="당신의 멋진 프로젝트의 이름을 작성해 주세요!" value="{{old("title")}}">
                                    <div class="bar"></div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="tag-box mt-2">
                                    <input type="hidden" class="value" name="main_lang" value="{{old("main_lang")}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-textarea mt-2">
                                    <textarea name="description" id="description" placeholder="프로젝트에 대한 간단한 설명을 작성해 주세요!">{{old("description")}}</textarea>
                                    <div class="bar"></div>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="f-left w-50">
                            ...
                            <div class="form-group flex">
                                <div class="flex items-bottom mr-5">
                                    ...
                                    <div class="color-picker-wrap">
                                        <div id="back-preview" class="color-picker mr-5" style="background-color: {{old("back_color") ? old("back_color") : "#ffffff"}}" data-target="back-color"></div>
                                    </div>
                                ...
                                <div class="flex items-bottom ml-5">
                                    ...
                                    <div class="color-picker-wrap">
                                        <div id="font-preview" class="color-picker mr-5" style="background-color: {{old("font_color") ? old("font_color") : "#000000"}}" data-target="font-color"></div>
                                    </div>
                                    <input type="color" id="font-color" name="font_color" value="{{old("font_color") ? old("font_color") : "#000000"}}">
                                </div>
                            </div>
                            <div class="form-group mt-3">
                                ...
                                <div class="tag-box mt-2">
                                    <input type="hidden" class="value" name="hash_tag" value="{{old("hash_tag")}}">
                                    <div class="input-area">
                                        @if(old('hash_tag'))
