                    ...
                    <div class="w-100">
                        <div class="f-left w-50">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file mt-2">
                                    ...
                                    <label for="execute_file" onclick="alert('zip 확장자 파일만 업로드 가능하니 참고하시기 바랍니다.')">{{is_file(project_path($project->saved_folder)."compress.zip") ? "compress.zip" : ""}}</label>
                        ...
                        <div class="f-left w-50">
                            <div class="form-group">
                                ...
                                <div class="form-help inline">업로드를 하지 않으면 기존 이미지가 그대로 유지됩니다.</div>
